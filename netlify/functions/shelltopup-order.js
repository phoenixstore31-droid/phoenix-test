  ...
  try {
    ...
    if (
      ...
      return json(200, {
        ...
        nickname: order.provider_nickname || null
      });
    }
    ...
    if (
      ...
      return json(400, {
        ok: false,
        refunded: true,
        error: "ShellTopup product mapping is missing."
      });
    }
    ...
    if (shellResult.ok) {
      ...
      if (providerStatus === "DELIVERED") {
        const updateData = {
          ...
          provider_shells_spent: shellsSpent,
          provider_error: null,
    ...
    const providerStatusCode =
      Number(shellResult.statusCode || 0);
